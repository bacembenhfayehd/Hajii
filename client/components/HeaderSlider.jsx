...
const HeaderSlider = () => {
  const sliderData = [
    {
      id: 1,
      title: "30% de séduction immédiate",
      offer: "Votre peau trépigne cette offre ne durera pas",
      buttonText1: "Acheter",
      buttonText2: "Découvrir",
      imgSrc: one,
    },
    {
      id: 2,
      title: "L'Excellence beauté vous attend",
      offer: "Stock limité - Pièces numérotées !",
      buttonText1: "Découvrir",
      buttonText2: "Collection",
      imgSrc: two,
    },
    {
      id: 3,
      title: "La Puissance du Naturel Rencontre l'Élégance",
      offer: "Édition Limitée - 40% de Réduction Exclusive",
      buttonText1: "Commander",
      buttonText2: "Découvrir",
      imgSrc: three,
    },
  ];
        ...
        {sliderData.map((slide, index) => (
          ...
          >
            <div className="md:pl-8 mt-10 md:mt-0">
              <p className="md:text-base text-green-700 pb-1">{slide.offer}</p>
